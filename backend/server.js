...
const SEED_DATA = {
  ...
  vehicles: [
    { id: "veh_1", reg_no: 'GJ01AB4521', name: 'VAN-05', type: 'Van', max_capacity_kg: 500, odometer_km: 74000, acquisition_cost: 620000, insurance_expiry: new Date(Date.now() + 420 * 86400000).toISOString().slice(0, 10), status: 'Available', last_service_odometer_km: 70000, region: 'Ahmedabad', current_location: 'Ahmedabad Depot' },
    { id: "veh_2", reg_no: 'GJ01AB9987', name: 'TRUCK-11', type: 'Truck', max_capacity_kg: 5000, odometer_km: 182000, acquisition_cost: 2450000, insurance_expiry: new Date(Date.now() + 180 * 86400000).toISOString().slice(0, 10), status: 'On Trip', last_service_odometer_km: 175000, region: 'Ahmedabad', current_location: 'Ahmedabad Hub' },
    { id: "veh_3", reg_no: 'GJ01AB1120', name: 'MINI-03', type: 'Mini', max_capacity_kg: 1000, odometer_km: 66000, acquisition_cost: 410000, insurance_expiry: new Date(Date.now() + 60 * 86400000).toISOString().slice(0, 10), status: 'In Shop', last_service_odometer_km: 60000, region: 'Gandhinagar', current_location: 'Gandhinagar Workshop' },
    { id: "veh_4", reg_no: 'GJ01AB0087', name: 'VAN-09', type: 'Van', max_capacity_kg: 750, odometer_km: 241900, acquisition_cost: 590000, insurance_expiry: new Date(Date.now() - 15 * 86400000).toISOString().slice(0, 10), status: 'Retired', last_service_odometer_km: 240000, region: 'Vatva', current_location: 'Vatva Yard' },
    { id: "veh_5", reg_no: 'GJ01AB2244', name: 'TRUCK-04', type: 'Truck', max_capacity_kg: 4500, odometer_km: 98000, acquisition_cost: 2100000, insurance_expiry: new Date(Date.now() + 250 * 86400000).toISOString().slice(0, 10), status: 'Available', last_service_odometer_km: 90000, region: 'Sanand', current_location: 'Sanand Warehouse' }
  ],
  drivers: [
    { id: "drv_1", name: 'Alex Fernandes', license_no: 'DL-88213', license_category: 'LMV', license_expiry: new Date(Date.now() + 540 * 86400000).toISOString().slice(0, 10), contact: '98765xxxxx', safety_score: 96, status: 'Available', current_location: 'Ahmedabad Hub' },
    { id: "drv_2", name: 'John Mathew', license_no: 'DL-44120', license_category: 'HMV', license_expiry: new Date(Date.now() - 90 * 86400000).toISOString().slice(0, 10), contact: '98220xxxxx', safety_score: 81, status: 'Suspended', current_location: 'Home Base' },
    { id: "drv_3", name: 'Priya Patel', license_no: 'DL-77031', license_category: 'LMV', license_expiry: new Date(Date.now() + 30 * 86400000).toISOString().slice(0, 10), contact: '99110xxxxx', safety_score: 99, status: 'On Trip', current_location: 'Gandhinagar Depot' },
    { id: "drv_4", name: 'Suresh Kumar', license_no: 'DL-90045', license_category: 'HMV', license_expiry: new Date(Date.now() + 200 * 86400000).toISOString().slice(0, 10), contact: '97440xxxxx', safety_score: 88, status: 'Available', current_location: 'Sanand Warehouse' }
  ],
  trips: [
